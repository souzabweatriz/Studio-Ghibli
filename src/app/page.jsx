...
export default function Home() {
  ...
  <div className='bg-white rounded-lg shadow-2xl shadow-black/40 p-6 max-w-2xl min-h-[25rem] min-w-[40%] flex flex-col items-center border-2 border-[#E36A97]'>
        <Image 
  className="rounded-full mb-6 mt-3 p-2 shadow-xl border-2 border-green-100" 
        src="/images/profile.png" 
        alt="Profile Picture" 
        width={130} 
        height={150} 
        />
        <h1 className="text-xl md:text-2xl font-bold mb-3 text-black tracking-wide text-center w-full">
  ...
  <blockquote className="italic text-black bg-[#FFDD6] rounded-xl px-6 py-4 shadow-inner border-l-4 border-[#E36A97] font-serif text-base md:text-lg max-w-lg w-full mx-auto text-center flex justify-center">
